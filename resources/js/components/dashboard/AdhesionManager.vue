        ...
        <div class="title align-items-center justify-content-between">
            <div class="d-flex align-items-center">
                <div class="text-uppercase"
                    style="font-size: x-large; color:gray; font-family: Verdana, Geneva, Tahoma, sans-serif;"><b>
                        Demande en attente
                    </b></div>
            </div>
            <div class="d-flex align-items-center">
            ...
            <tbody>
                <tr v-for="(user, index) in users.data" :key="index + 'dfg'">
                    ...
                    <td style="vertical-align: middle;">
                        <i @click="showAdhModal(user, 'ACCEPT')" title="Accpeter la demande" class="bi bi-hand-thumbs-up" style="color:green; cursor:pointer"></i>
                    </td>
                    <td style="vertical-align: middle;">
                        <i @click="showAdhModal(user, 'DENIE')" title="Décliner la demande" class="bi bi-hand-thumbs-down" style="color:red; font-size: 17px;cursor: pointer;"></i>
                    </td>
                </tr>
            </tbody>
        </table>
...
import ConfirmAdhModal from '../modals/ConfirmAdhModal.vue';
export default {
    components: {
    },
    mounted() {
        ...
        axios.get("api/get-list-adhesion", {})
    ...
    methods: {
        ...
        showAdhModal(user, decision){
            const props = {
                title: `Confirmation de votre décision`,
                decision: decision,
                user: user
            }
            openModal(ConfirmAdhModal, props)
        },
    }
}
</script>
